var giga = {
  ...
  showTool: function () {
    ...
    if ("undefined" == typeof window.gigainit || !window.gigainit) {
      ...
      for (
        var a = 0;
        5 > a && void 0 != document.querySelectorAll("div.gigacalculator")[a];
        a++
      ) {
        var b = document
            .querySelectorAll("div.gigacalculator")
            [a].getAttribute("data-tool"),
          c = document
            .querySelectorAll("div.gigacalculator")
            [a].getAttribute("data-width");
        b = 0 < b.indexOf("?") ? b + "&" : b + "?";
        document.querySelectorAll("div.gigacalculator")[a].style =
          "width: " + c + "px;";
        ...
        document.querySelectorAll("div.gigacalcfooter>a")[a].style =
          "text-decoration: none; font-size: 12px !important; color: #1b6997 !important;";
        document.querySelectorAll("a.gigacalclink")[a].style =
          "text-decoration: none; color: #1b6997 !important;";
        document.querySelectorAll("a.gigacalclink")[a].innerHTML =
          '<img src="https://cdn.gigacalculator.com/img/Gigacalculator-logo.png" style="vertical-align: middle; display: inline; box-shadow: none;" alt="GIGAcalculator.com" />';
        document
          .querySelectorAll("div.gigacalctitle")
          [a].insertAdjacentHTML(
            "afterend",
            '<iframe id="gigaframe" src="https://www.gigacalculator.com' +
              b +
              'embed=true" style="display: block; border: none; width: 100%; margin: 0px; padding: 0px; height: 240px; visibility: visible; opacity: 1;"></iframe>'
          );
      }
    }
  },
...
window.addEventListener("message", function (a) {
  ~a.origin.indexOf("https://www.gigacalculator.com") &&
    ((giga.iframeHeight = a.data), giga.resizeIframe());
});
...
giga.clearResultHooks = function () {
  ...
  void 0 != calcRes &&
    ...
    Array.prototype.forEach.call(
      document.querySelectorAll("form#calculator input"),
      function (a, b) {
    ...
    Array.prototype.forEach.call(
      document.querySelectorAll("form#calculator select"),
      function (a, b) {
        a.addEventListener("change", function () {
          "none" != calcResDis && (calcRes.style.display = "none");
        });
    ...
    Array.prototype.forEach.call(
      document.querySelectorAll("form#calculator radio"),
      function (a, b) {
        a.addEventListener("change", function () {
          "none" != calcResDis && (calcRes.style.display = "none");
        });
